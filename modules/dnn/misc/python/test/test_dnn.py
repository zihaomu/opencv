...
class dnn_test(NewOpenCVTests):
    ...
    def test_blobFromImageParam(self):
        np.random.seed(324)
        ...
        blob = cv.dnn.blobFromImageParam(img, param)
        blob_args = cv.dnn.blobFromImageParam(img, cv.dnn.ImagePParam(scalefactor=scalefactor, size=(6, 7), mean=mean,
